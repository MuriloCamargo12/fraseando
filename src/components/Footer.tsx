    ...
    return (
        <footer>
            <div className="flex justify-center gap-5 p-10">
                <a href="https://github.com/MuriloCamargo12" target="_blank"><IconBrandGithub size={50} className="text-neutral-400 transition-all duration-300 hover:text-white" /></a>
